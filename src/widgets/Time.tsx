...
export const TimeWidget = (dateProps: dateProp) => {
  ...
  return (
    <>
      <div
        className="bg-slate-50 dark:bg-slate-700 hover:brightness-95 dark:hover:brightness-125 rounded-3xl hover:shadow-md p-4 w-fit text-center cursor-pointer flex flex-col max-lg:flex-row"
      ...
      >
        ...
        <Modal.Body className="slide-up">
          <div className="flex justify-between mt-5">
            <DateFilter
              yearC={dateProps.yearC}
              setYearC={dateProps.setYearC}
              monthC={dateProps.monthC}
              setMonthC={dateProps.setMonthC}
            />
          </div>
        </Modal.Body>
      </Modal>
