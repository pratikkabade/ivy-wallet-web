            ...
            {show && (
                ...
                >
                            ...
                            <div className="slide-up flex flex-col justify-center">
                                ...
                                {error &&
                                    <p className="flex flex-row flex-wrap justify-center text-xl lg:text-3xl my-5 fade-in2">
                                        {!success && <span className="text-rose-700 dark:text-rose-200">{error}</span>}
                                        {success && error}
                                        {success && <span className="ml-2 font-semibold">{UserName()}</span>}
                                    </p>
                                }
                            </div>
                        </div>
                    ...
                    <Modal.Footer className="flex justify-around items-center">
                        {success ?
                            <button onClick={() => { setOpenModal('false') }} type="button" className="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 fade-in">
                                Continue
                            </button>
                            :
                            <ForgotPin />
