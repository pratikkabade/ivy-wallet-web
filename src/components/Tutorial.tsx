...
export const Tutorial = () => {
  ...
  function copyLink() {
    let link =
      "https://raw.githubusercontent.com/dependabot-pr/ivy/sample/data.json";
    ...
    <div className="mx-auto py-10 w-2/4 justify-center" id="tutorial">
      <div className="slide-up">
        ...
        <p className="text-xl lg:text-3xl mb-10 text-left font-semibold">
          1. Go to{" "}
          <a
            className="text-sky-700 dark:text-sky-300 hover:brightness-150 hover:underline"
            href="https://www.github.com"
          >
            GitHub
          </a>
          , create a new repository and upload the <code>json file</code>
        </p>
        ...
        <p className="text-xl lg:text-3xl mb-10 text-left font-semibold">
          {show ? (
            ...
            <span className="text-sky-700 dark:text-sky-300 underline mr-2">
              Link copied
            </span>
          )}
