...
export const SettingsButton = () => {
  ...
  return (
    <>
      <div
        className="flex flex-row align-middle justify-center items-center lg:w-48 max-lg:w-fit max-lg:h-fit p-5 m-1 rounded-2xl hover:shadow-sm cursor-pointer transition duration-300 ease-in-out bg-slate-50 dark:bg-slate-700 hover:brightness-95 dark:hover:brightness-125 text-xl font-bold"
        onClick={() => props.setOpenModal("default")}
      >
        <i className="fas fa-cog mr-2 max-lg:mr-0"></i>
        <div className="max-lg:hidden">Settings</div>
      </div>
